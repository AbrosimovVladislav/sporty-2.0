...
| type | text? | Тип покрытия: `open` (открытое), `indoor` (манеж), `covered` (крытое) |
| format | text? | Формат поля: `5×5`, `7×7`, `11×11` и т.п. |
| rating | numeric(2,1)? | Средний рейтинг по отзывам, 0..5 |
