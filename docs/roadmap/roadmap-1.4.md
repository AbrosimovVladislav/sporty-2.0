...
8. **Финансы — два режима:**
   ...
   - *Организатору:* единая карточка с двумя строками («Площадка» и «Сборы с игроков»), у каждой строки прогресс-бар оплаты; справа — бейдж статуса или кнопка «Должны N» с разворотом списка должников
